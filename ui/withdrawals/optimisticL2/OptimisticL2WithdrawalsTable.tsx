    ...
    <AddressHighlightProvider>
      <TableRoot tableLayout="auto" minW="950px">
        <TableHeaderSticky top={ top }>
          <TableRow>
            <TableColumnHeader>{ t('withdrawals.msgNonceLabel') }</TableColumnHeader>
            <TableColumnHeader>{ t('withdrawals.fromLabel') }</TableColumnHeader>
            ...
            <TableColumnHeader>{ t('withdrawals.statusLabel') }</TableColumnHeader>
            <TableColumnHeader>{ t('withdrawals.parentTxnHash', { parent: layerLabels.parent }) }</TableColumnHeader>
            <TableColumnHeader>{ t('withdrawals.timeLeftLabel') }</TableColumnHeader>
          </TableRow>
        </TableHeaderSticky>
        <TableBody>
