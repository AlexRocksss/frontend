...
const PoolsListItem = ({ item, isLoading }: Props) => {
  ...
  return (
    <ListItemMobileGrid.Container gridTemplateColumns="100px auto">
      ...
      <ListItemMobileGrid.Label isLoading={ isLoading }>{ t('pools.pool') }</ListItemMobileGrid.Label>
      ...
      { item.is_contract && (
        <>
          <ListItemMobileGrid.Label isLoading={ isLoading }>{ t('pools.contract') }</ListItemMobileGrid.Label>
          <ListItemMobileGrid.Value>
      ...
      { !item.is_contract && (
        <>
          <ListItemMobileGrid.Label isLoading={ isLoading }>{ t('pools.poolId') }</ListItemMobileGrid.Label>
          <ListItemMobileGrid.Value>
      ...
      <ListItemMobileGrid.Label isLoading={ isLoading }>{ t('pools.liquidity') }</ListItemMobileGrid.Label>
      <ListItemMobileGrid.Value>
      ...
      <ListItemMobileGrid.Label isLoading={ isLoading }>{ t('pools.viewIn') }</ListItemMobileGrid.Label>
      <ListItemMobileGrid.Value>
        <Skeleton loading={ isLoading }>
